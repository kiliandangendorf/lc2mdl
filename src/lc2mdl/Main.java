...
public class Main{
	...
	public static void main(String[] args){
		...
		final boolean findRecursively=cmd.optionIsSet("-r");
		...
		//if folder, copy inputfile-name and create new files according to inputfile-name
	...
	private static void findProblemFilesRecursively(final File inputfolder, final File outputfolder, HashMap<String,String> files, boolean findRecursively){
